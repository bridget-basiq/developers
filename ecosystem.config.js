module.exports = {
  ...
  deploy: {
    production: {
      ...
      'post-deploy':
        'git checkout main && git pull origin master && git branch -D fix/dev-portal/content-edit && git checkout -b fix/dev-portal/content-edit && npm install && pm2 restart all',
    },
  },
}
