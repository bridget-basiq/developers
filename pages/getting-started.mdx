...
<step number="1" img="getting-access.png">
  ...
  <c-button size="md" color="accent" title="Sign up" />
  <c-button size="md" color="alt" title="Sign in" />
</step>
<step number="2" img="configuring-your-project.png">
  ...
  <step-note color="alt" title="Chargetrip">
...
<step number="3" img="collect-your-keys.png">
